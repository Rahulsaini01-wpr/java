...
public class Main {
	public static void main(String[] args) {
		...
		// Removing a key-value pair (3, "Angular") and checking if removal was successful
		boolean isRemoved = map.remove(3, "Angular");
		System.out.println("Was the key-value pair (3, 'Angular') removed? " + isRemoved);
