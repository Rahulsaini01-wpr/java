            ...
            while (true) {
                try {
                    ...
                    if (row >= 0 && row < 3 && col >= 0 && col < 3 && grid[row][col] == ' ') {
                        ...
                        System.out.println("Invalid move. Please enter a row and column between 0 and 2, and make sure the cell is empty.");
                    }
                } catch (Exception e) {
                    System.out.println("Invalid input. Please enter integers for row and column between 0 and 2.");
